...
def matrix_to_features():
    file_name = '../Data/pref_attach/preferential_attachment_model_with_params_10_2_300-20210118-163357.p'
    ...
    features_file_name = '../Data/pref_attach/features_pref_attach_params_10_2_300-20210118-163357.p'
    pickle.dump(features_matrix, open(features_file_name, 'wb'))

matrix_to_features()

file_name = '../Data/pref_attach/features_pref_attach_params_10_2_300-20210118-163357.p'
features_matrix = np.array(pickle.load(open(file_name, 'rb')))
data_plot(features_matrix, save=True)
